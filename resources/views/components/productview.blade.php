...
{{--        <img alt="product_image" class="bg-darkBrownish bg-opacity-50 object-cover object-center w-full h-full block" src="/storage/{{$product->Image}}">--}}
    ...
    <div class="mt-4">
        ...
        <p class="mt-1 text-darkerBrownish">{{$product->price}}</p>
    </div>
</div>
